...
CREATE TABLE `Analytics` (
    ...
    `messageSend` INTEGER NOT NULL DEFAULT 0,
    `messageRecieved` INTEGER NOT NULL DEFAULT 0,
    `webhookCall` INTEGER NOT NULL DEFAULT 0,
    `webhookFails` INTEGER NOT NULL DEFAULT 0,
    `isMediaSend` INTEGER NOT NULL DEFAULT 0,
    `isMediaRecieved` INTEGER NOT NULL DEFAULT 0,
    `sendDataSize` INTEGER NOT NULL DEFAULT 0,
    `recieveDataSize` INTEGER NOT NULL DEFAULT 0,
    `date` VARCHAR(191) NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,

    INDEX `Analytics_createdAt_idx`(`createdAt`),
    UNIQUE INDEX `Analytics_domain_date_key`(`domain`, `date`),
    PRIMARY KEY (`id`)
